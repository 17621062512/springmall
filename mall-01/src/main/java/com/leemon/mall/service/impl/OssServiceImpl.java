...
public class OssServiceImpl implements OssService {
    ...
    public OssPolicyResult policy() {
        ...
        callbackParam.setCallbackBodyType(ContentType.FORM_URLENCODED.toString());
